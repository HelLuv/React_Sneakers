		...
		<div className={styles.card}>
			{loading ? (
				...
				<>
					...
					<img width="100%" height={135} src={imageUrl} alt="card_item" />
					<h3>{name}</h3>
					<div className="d-flex justify-between align-center">
						<div className="d-flex flex-column">
							<span>ЦЕНА:</span>
							<b>{(price).toLocaleString('ru')} руб.</b>
						</div>
						{onPlus && <img
